...
var grammar = {
    ...
    {"name": "VP__num_sing_fin_p$string$1", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "VP__num_sing_fin_p", "symbols": ["AUX_num_sing_fin_p", "_", "VP__num_sing_fin_p$string$1", "_", "VP_num_sing_fin_n"], "postprocess": (args) => node("VP'", {"num":"sing","fin":"+"}, args)},
    {"name": "VP__num_sing_fin_p", "symbols": ["VP_num_sing_fin_p"], "postprocess": (args) => node("VP'", {"num":"sing","fin":"+"}, args)},
    {"name": "VP__num_plur_fin_p$string$1", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "VP__num_plur_fin_p", "symbols": ["AUX_num_plur_fin_p", "_", "VP__num_plur_fin_p$string$1", "_", "VP_num_plur_fin_n"], "postprocess": (args) => node("VP'", {"num":"plur","fin":"+"}, args)},
    {"name": "VP__num_plur_fin_p", "symbols": ["VP_num_plur_fin_p"], "postprocess": (args) => node("VP'", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_sing_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_sing_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_sing_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_plur_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_plur_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_p", "_", "NP_num_plur_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_p", "symbols": ["V_num_sing_fin_p_trans_n"], "postprocess": (args) => node("VP", {"num":"sing","fin":"+"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_sing_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_sing_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_sing_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_plur_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_plur_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_p", "_", "NP_num_plur_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_sing_fin_n", "symbols": ["V_num_sing_fin_n_trans_n"], "postprocess": (args) => node("VP", {"num":"sing","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_sing_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_sing_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_sing_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_plur_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_plur_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_p", "_", "NP_num_plur_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_p", "symbols": ["V_num_plur_fin_p_trans_n"], "postprocess": (args) => node("VP", {"num":"plur","fin":"+"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_sing_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_sing_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_sing_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_plur_gen_male_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_plur_gen_fem_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    {"name": "VP_num_plur_fin_n", "symbols": ["V_num_plur_fin_n_trans_p", "_", "NP_num_plur_gen_nhum_case_nnom"], "postprocess": (args) => node("VP", {"num":"plur","fin":"-"}, args)},
    ...
    {"name": "NP_num_sing_gen_male_case_pnom", "symbols": ["PRO_num_sing_gen_male_case_pnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"male","case":"+nom"}, args)},
    ...
    {"name": "NP_num_sing_gen_male_case_nnom", "symbols": ["PRO_num_sing_gen_male_case_nnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"male","case":"-nom"}, args)},
    ...
    {"name": "NP_num_sing_gen_fem_case_pnom", "symbols": ["PRO_num_sing_gen_fem_case_pnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"fem","case":"+nom"}, args)},
    ...
    {"name": "NP_num_sing_gen_fem_case_nnom", "symbols": ["PRO_num_sing_gen_fem_case_nnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"fem","case":"-nom"}, args)},
    ...
    {"name": "NP_num_sing_gen_nhum_case_pnom", "symbols": ["PRO_num_sing_gen_nhum_case_pnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"-hum","case":"+nom"}, args)},
    ...
    {"name": "NP_num_sing_gen_nhum_case_nnom", "symbols": ["PRO_num_sing_gen_nhum_case_nnom"], "postprocess": (args) => node("NP", {"num":"sing","gen":"-hum","case":"-nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_male_case_pnom", "symbols": ["PRO_num_plur_gen_male_case_pnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"male","case":"+nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_male_case_nnom", "symbols": ["PRO_num_plur_gen_male_case_nnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"male","case":"-nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_fem_case_pnom", "symbols": ["PRO_num_plur_gen_fem_case_pnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"fem","case":"+nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_fem_case_nnom", "symbols": ["PRO_num_plur_gen_fem_case_nnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"fem","case":"-nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_nhum_case_pnom", "symbols": ["PRO_num_plur_gen_nhum_case_pnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"-hum","case":"+nom"}, args)},
    ...
    {"name": "NP_num_plur_gen_nhum_case_nnom", "symbols": ["PRO_num_plur_gen_nhum_case_nnom"], "postprocess": (args) => node("NP", {"num":"plur","gen":"-hum","case":"-nom"}, args)},
