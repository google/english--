...
var grammar = {
    ...
    {"name": "NP_", "symbols": ["NP", "__", "NP_$subexpression$1", "__", "NP"], "postprocess": (d, l, r) => ((root) => { return node('NP', root.types, root.children, root.loc); })(process("NP'", {"num":"plur","case":2,"gap":"-"}, d, [{"num":3,"case":2,"gap":"-"},{},{},{},{"num":4,"case":2,"gap":"-"}], l, r))},
    {"name": "NP_", "symbols": ["NP"], "postprocess": (d, l, r) => ((root) => { return root.children[0]; })(process("NP'", {"num":1,"case":3,"gap":4}, d, [{"num":1,"case":3,"gap":4}], l, r))},
    ...
    {"name": "V", "symbols": ["V"], "postprocess": (d, l, r) => ((root) => { if (root == r) return r; return node(root['@type'], root.types, root.children[0].children, root.loc); })(process("V", {"num":"plur","fin":"+","stat":2,"trans":1,"tp":"-past","tense":"pres"}, d, [{"num":"sing","fin":"-","stat":2,"trans":1,"tp":"-past","tense":"pres"}], l, r))},
