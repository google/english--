...
Sentence -> "who"i _ NP __ VP_ _ "?"i {% (d, l, r) => process("Sentence", {}, d, [{},{},{"num":1,"gen":5,"case":"+nom","gap":"+"},{},{"num":1,"fin":"+","stat":2,"gap":"-","tp":4,"tense":3},{},{}], l, r) %}
Sentence -> "who"i __ AUX __ NP __ VP _ "?"i {% (d, l, r) => process("Sentence", {}, d, [{},{},{"num":"sing","fin":"+","tp":5,"tense":4},{},{"num":1,"gen":6,"case":"+nom","gap":"-"},{},{"num":3,"fin":"+","stat":2,"gap":"+","tp":5,"tense":4},{},{}], l, r) %}
Sentence -> "is"i __ NP __ ADJ _ "?"i {% (d, l, r) => process("Sentence", {}, d, [{},{},{"num":"sing","gen":1,"case":"+nom","gap":"-"},{},{},{},{}], l, r) %}
S -> NP_ __ VP_ {% (d, l, r) => process("S", {"num":1,"stat":2,"gap":"-","tp":4,"tense":3}, d, [{"num":1,"gen":5,"case":"+nom","gap":"-"},{},{"num":1,"fin":"+","stat":2,"gap":"-","tp":4,"tense":3}], l, r) %}
S -> NP_ WS VP_ {% (d, l, r) => process("S", {"num":1,"stat":2,"gap":"+","tp":5,"tense":4}, d, [{"num":1,"gen":6,"case":"+nom","gap":"+"},{"gap":"-"},{"num":1,"fin":"+","stat":2,"gap":"-","tp":5,"tense":4}], l, r) %}
S -> NP_ WS VP_ {% (d, l, r) => process("S", {"num":1,"stat":2,"gap":"+","tp":5,"tense":4}, d, [{"num":3,"gen":6,"case":"+nom","gap":"+"},{"gap":"-"},{"num":1,"fin":"+","stat":2,"gap":"-","tp":5,"tense":4}], l, r) %}
S -> NP_ __ VP_ {% (d, l, r) => process("S", {"num":1,"stat":2,"gap":"+","tp":5,"tense":4}, d, [{"num":1,"gen":6,"case":"+nom","gap":"-"},{},{"num":1,"fin":"+","stat":2,"gap":"+","tp":5,"tense":4}], l, r) %}
...
VP -> V WS NP_ {% (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":"+","tp":6,"tense":5}, d, [{"num":1,"fin":2,"stat":4,"trans":"+","tp":6,"tense":5},{"gap":"-"},{"num":3,"gen":7,"case":"-nom","gap":"+"}], l, r) %}
VP -> V __ NP_ {% (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":"-","tp":6,"tense":5}, d, [{"num":1,"fin":2,"stat":4,"trans":"+","tp":6,"tense":5},{},{"num":3,"gen":7,"case":"-nom","gap":"-"}], l, r) %}
VP -> V {% (d, l, r) => process("VP", {"num":1,"fin":2,"stat":3,"gap":"-","tp":5,"tense":4}, d, [{"num":1,"fin":2,"stat":3,"trans":"-","tp":5,"tense":4}], l, r) %}
NP -> GAP {% (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"+"}, d, [{}], l, r) %}
NP -> DET __ N {% (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":1},{},{"num":1,"gen":2}], l, r) %}
NP -> PN {% (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":1,"gen":2}], l, r) %}
NP -> PRO {% (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":1,"gen":2,"case":3,"refl":4}], l, r) %}
NP_ -> NP __ "and"i __ NP {% (d, l, r) => ((root) => { return node('NP', root.types, root.children, root.loc); })(process("NP'", {"num":"plur","gen":"?","case":2,"gap":"-"}, d, [{"num":3,"gen":5,"case":2,"gap":"-"},{},{},{},{"num":4,"gen":6,"case":2,"gap":"-"}], l, r)) %}
NP_ -> NP {% (d, l, r) => ((root) => { return root.children[0]; })(process("NP'", {"num":1,"gen":2,"case":3,"gap":4}, d, [{"num":1,"gen":2,"case":3,"gap":4}], l, r)) %}
N -> N __ RC {% (d, l, r) => process("N", {"num":1,"gen":2}, d, [{"num":1,"gen":2},{},{"num":1}], l, r) %}
...
VP -> BE __ NP {% (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":3,"tp":7,"tense":6}, d, [{"num":1,"fin":2,"tp":7,"tense":6},{},{"num":1,"gen":8,"case":5,"gap":3}], l, r) %}
VP -> BE __ PP {% (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5}, d, [{"num":1,"fin":2,"tp":6,"tense":5},{},{}], l, r) %}
N -> ADJ __ N {% (d, l, r) => process("N", {"num":1,"gen":2}, d, [{},{},{"num":1,"gen":2}], l, r) %}
...
NP_ -> NP __ "or"i __ NP {% (d, l, r) => ((root) => { return node('NP', root.types, root.children, root.loc); })(process("NP'", {"num":3,"gen":4,"case":2,"gap":"-"}, d, [{"num":3,"gen":4,"case":2,"gap":"-"},{},{},{},{"num":3,"gen":4,"case":2,"gap":"-"}], l, r)) %}
NP_ -> NP __ "or"i __ NP {% (d, l, r) => ((root) => { return node('NP', root.types, root.children, root.loc); })(process("NP'", {"num":3,"gen":"?","case":2,"gap":"-"}, d, [{"num":3,"gen":4,"case":2,"gap":"-"},{},{},{},{"num":3,"gen":5,"case":2,"gap":"-"}], l, r)) %}
S -> S __ "and"i __ S {% (d, l, r) => process("S", {"num":1,"stat":2,"gap":5,"tp":4,"tense":3}, d, [{"num":1,"stat":2,"gap":"-","tp":4,"tense":3},{},{},{},{"num":1,"stat":2,"gap":"-","tp":4,"tense":3}], l, r) %}
...
NP -> DET __ RN {% (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":"sing","rn":"+"},{},{"num":1,"gen":2}], l, r) %}
DET -> PN "'s"i {% (d, l, r) => process("DET", {"num":"sing","rn":"+"}, d, [{"num":1,"gen":2},{}], l, r) %}
N -> N __ PP {% (d, l, r) => process("N", {"num":1,"gen":2}, d, [{"num":1,"gen":2},{},{}], l, r) %}
PP -> PREP __ NP {% (d, l, r) => process("PP", {}, d, [{},{},{"num":1,"gen":2,"case":3,"gap":"-"}], l, r) %}
...
PRO -> "he"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"male","case":"+nom","refl":"-"}, d, [{}], l, r) %}
PRO -> "him"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"male","case":"-nom","refl":"-"}, d, [{}], l, r) %}
PRO -> "she"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"fem","case":"+nom","refl":"-"}, d, [{}], l, r) %}
PRO -> "her"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"fem","case":"-nom","refl":"-"}, d, [{}], l, r) %}
PRO -> "it"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"-hum","case":["-nom","+nom"],"refl":"-"}, d, [{}], l, r) %}
PRO -> "they"i {% (d, l, r) => process("PRO", {"num":"plur","gen":["male","fem","-hum"],"case":"+nom","refl":"-"}, d, [{}], l, r) %}
PRO -> "them"i {% (d, l, r) => process("PRO", {"num":"plur","gen":["male","fem","-hum"],"case":"-nom","refl":"-"}, d, [{}], l, r) %}
PN -> "Jones"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "John"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Mel"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Leo"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Yuji"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Smith"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Socrates"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Sam"i {% (d, l, r) => process("PN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
PN -> "Mary"i {% (d, l, r) => process("PN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
PN -> "Dani"i {% (d, l, r) => process("PN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
PN -> "Anna"i {% (d, l, r) => process("PN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
PN -> "Brazil"i {% (d, l, r) => process("PN", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
PN -> "Italy"i {% (d, l, r) => process("PN", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
PN -> "Ulysses"i {% (d, l, r) => process("PN", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
N -> "stockbroker"i {% (d, l, r) => process("N", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
N -> "man"i {% (d, l, r) => process("N", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
N -> "engineer"i {% (d, l, r) => process("N", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
N -> "brazilian"i {% (d, l, r) => process("N", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
N -> "stockbroker"i {% (d, l, r) => process("N", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
N -> "woman"i {% (d, l, r) => process("N", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
N -> "widow"i {% (d, l, r) => process("N", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
N -> "engineer"i {% (d, l, r) => process("N", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
N -> "brazilian"i {% (d, l, r) => process("N", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
N -> "book"i {% (d, l, r) => process("N", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
N -> "donkey"i {% (d, l, r) => process("N", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
N -> "horse"i {% (d, l, r) => process("N", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
N -> "porsche"i {% (d, l, r) => process("N", {"num":"sing","gen":"-hum"}, d, [{}], l, r) %}
...
PRO -> "himself"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"male","case":"-nom","refl":"+"}, d, [{}], l, r) %}
PRO -> "herself"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"fem","case":"-nom","refl":"+"}, d, [{}], l, r) %}
PRO -> "itself"i {% (d, l, r) => process("PRO", {"num":"sing","gen":"-hum","case":"-nom","refl":"+"}, d, [{}], l, r) %}
...
RN -> "husband"i {% (d, l, r) => process("RN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
RN -> "father"i {% (d, l, r) => process("RN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
RN -> "brother"i {% (d, l, r) => process("RN", {"num":"sing","gen":"male"}, d, [{}], l, r) %}
RN -> "wife"i {% (d, l, r) => process("RN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
RN -> "mother"i {% (d, l, r) => process("RN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
RN -> "sister"i {% (d, l, r) => process("RN", {"num":"sing","gen":"fem"}, d, [{}], l, r) %}
RN -> "parent"i {% (d, l, r) => process("RN", {"num":"sing","gen":["male","fem"]}, d, [{}], l, r) %}
RN -> "child"i {% (d, l, r) => process("RN", {"num":"sing","gen":["male","fem"]}, d, [{}], l, r) %}
RN -> "sibling"i {% (d, l, r) => process("RN", {"num":"sing","gen":["male","fem"]}, d, [{}], l, r) %}
...
PN -> FULLNAME {% (d, l, r) => process("PN", {"num":"sing","gen":"?"}, d, [{}], l, r) %}
PN -> VAR {% (d, l, r) => process("PN", {"num":"sing","gen":"?"}, d, [{}], l, r) %}
