...
var grammar = {
    ...
    {"name": "V_num_sing_fin_n_trans_p", "symbols": ["V_trans_p"], "postprocess": ([child], loc) => child},
    ...
    {"name": "V_num_sing_fin_n_trans_n", "symbols": ["V_trans_n"], "postprocess": ([child], loc) => child},
    ...
    {"name": "V_num_plur_fin_n_trans_p", "symbols": ["V_trans_p"], "postprocess": ([child], loc) => child},
    ...
    {"name": "V_num_plur_fin_n_trans_n", "symbols": ["V_trans_n"], "postprocess": ([child], loc) => child},
    ...
    {"name": "V_trans_p$subexpression$1", "symbols": [/[lL]/, /[iI]/, /[kK]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$1"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$2", "symbols": [/[lL]/, /[oO]/, /[vV]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$2"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$3", "symbols": [/[aA]/, /[dD]/, /[mM]/, /[iI]/, /[rR]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$3"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$4", "symbols": [/[kK]/, /[nN]/, /[oO]/, /[wW]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$4"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$5", "symbols": [/[oO]/, /[wW]/, /[nN]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$5"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$6", "symbols": [/[fF]/, /[aA]/, /[sS]/, /[cC]/, /[iI]/, /[nN]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$6"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$7", "symbols": [/[rR]/, /[oO]/, /[tT]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$7"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_p$subexpression$8", "symbols": [/[sS]/, /[uU]/, /[rR]/, /[pP]/, /[rR]/, /[iI]/, /[sS]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_p", "symbols": ["V_trans_p$subexpression$8"], "postprocess": (args, loc) => node("V", {"trans":"+"}, args, loc)},
    {"name": "V_trans_n$subexpression$1", "symbols": [/[lL]/, /[oO]/, /[vV]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_n", "symbols": ["V_trans_n$subexpression$1"], "postprocess": (args, loc) => node("V", {"trans":"-"}, args, loc)},
    {"name": "V_trans_n$subexpression$2", "symbols": [/[sS]/, /[tT]/, /[iI]/, /[nN]/, /[kK]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_n", "symbols": ["V_trans_n$subexpression$2"], "postprocess": (args, loc) => node("V", {"trans":"-"}, args, loc)},
    {"name": "V_trans_n$subexpression$3", "symbols": [/[aA]/, /[dD]/, /[oO]/, /[rR]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_trans_n", "symbols": ["V_trans_n$subexpression$3"], "postprocess": (args, loc) => node("V", {"trans":"-"}, args, loc)},
