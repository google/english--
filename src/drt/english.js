...
var grammar = {
    ...
    {"name": "V_num_sing_fin_p_trans_n$subexpression$2", "symbols": [/[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V_num_sing_fin_p_trans_n", "symbols": ["V_num_sing_fin_n_trans_n", "V_num_sing_fin_p_trans_n$subexpression$2"], "postprocess": ([inf, s], loc) => { inf.children[0] += s; return inf; }},
