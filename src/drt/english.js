...
function name(head, tail, reject) {
 ...
 const {capture, match, merge, resolve, process, node} = require("./processor.js"); var grammar = {
    ...
    {"name": "VP", "symbols": ["BE", "__", "ADJ"], "postprocess": (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5}, d, [{"num":1,"fin":2,"tp":6,"tense":5},{},{}], l, r, undefined, undefined)},
    {"name": "VP$subexpression$1", "symbols": [/[nN]/, /[oO]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "VP", "symbols": ["BE", "__", "VP$subexpression$1", "__", "ADJ"], "postprocess": (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5}, d, [{"num":1,"fin":2,"tp":6,"tense":5},{},{},{},{}], l, r, undefined, undefined)},
    ...
    {"name": "VP", "symbols": ["VP", "__", "VP$subexpression$2", "__", "VP"], "postprocess": (d, l, r) => process("VP", {"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5}, d, [{"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5},{},{},{},{"num":1,"fin":2,"stat":4,"gap":3,"tp":6,"tense":5}], l, r, undefined, undefined)},
    ...
    {"name": "VP", "symbols": ["HAVE", "__", "VP$subexpression$3", "__", "VP"], "postprocess": (d, l, r) => process("VP", {"num":1,"fin":"+","stat":"+","gap":3,"tp":4,"tense":5}, d, [{"num":1,"fin":"+","tp":4,"tense":5},{},{},{},{"num":1,"fin":"part","stat":6,"gap":3,"tp":4,"tense":5}], l, r, undefined, undefined)},
    ...
    {"name": "V$subexpression$26", "symbols": [/[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V", "symbols": ["V", "V$subexpression$26"], "postprocess":  (d, l, r) => process("V", {"num":"sing","fin":"+","stat":2,"trans":1,"tp":"-past","tense":"pres"}, d, [{"num":"sing","fin":"-","stat":2,"trans":1,"tp":"-past","tense":"pres"},{}], l, r, 
            (root) => node(root['@type'], 
                           root.types, 
    ...
    {"name": "V$subexpression$27", "symbols": [/[eE]/, /[sS]/], "postprocess": function(d) {return d.join(""); }},
    ...
    {"name": "V$subexpression$28", "symbols": [/[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V", "symbols": ["V", "V$subexpression$28"], "postprocess":  (d, l, r) => process("V", {"num":1,"fin":"+","stat":2,"trans":3,"tp":"+past","tense":"past"}, d, [{"num":1,"fin":"-","stat":2,"trans":3,"tp":"+past","tense":"pres"},{}], l, r, 
            (root) => node(root['@type'], 
                           root.types, 
                           [root.children[0].children[0] + root.children[1]],
                           root.loc,
    ...
    {"name": "V", "symbols": ["V", "V$subexpression$31"], "postprocess":  (d, l, r) => process("V", {"num":1,"fin":"part","stat":2,"trans":3,"tp":4,"tense":5}, d, [{"num":1,"fin":"-","stat":2,"trans":3,"tp":"+past","tense":"pres"},{}], l, r, 
        (root) => node(root['@type'], 
                       root.types, 
                       [root.children[0].children[0] + root.children[1]],
                       root.loc,
