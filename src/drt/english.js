...
function name(head, tail, reject) {
 ...
 const {capture, match, merge, resolve, process, node} = require("./processor.js"); var grammar = {
    ...
    {"name": "V", "symbols": ["V", "V$subexpression$26"], "postprocess":  (d, l, r) => process("V", {"num":"sing","fin":"+","stat":2,"trans":1,"tp":"-past","tense":"pres"}, d, [{"num":"sing","fin":"-","stat":2,"trans":1,"tp":"-past","tense":"pres"},{}], l, r, (root) => node(root['@type'], 
        root.types, 
        [root.children[0].children[0] + root.children[1]],
        root.loc,
        {"root": root.children[0].children[0]}), undefined) },
    ...
    {"name": "V", "symbols": ["V", "V$subexpression$27"], "postprocess":  (d, l, r) => process("V", {"num":1,"fin":"+","stat":2,"trans":3,"tp":"+past","tense":"past"}, d, [{"num":1,"fin":"-","stat":2,"trans":3,"tp":"+past","tense":"pres"},{}], l, r, (root) => node(root['@type'], 
        root.types, 
        [root.children[0].children[0] + root.children[1]],
        root.loc,
        {"root": root.children[0].children[0]}), undefined) },
    {"name": "V$subexpression$28", "symbols": [/[eE]/, /[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "V", "symbols": ["V", "V$subexpression$28"], "postprocess":  (d, l, r) => process("V", {"num":1,"fin":"part","stat":2,"trans":3,"tp":4,"tense":5}, d, [{"num":1,"fin":"-","stat":2,"trans":3,"tp":"+past","tense":"pres"},{}], l, r, (root) => node(root['@type'], 
        root.types, 
        [root.children[0].children[0] + root.children[1]],
        root.loc,
        {"root": root.children[0].children[0]}), undefined) },
