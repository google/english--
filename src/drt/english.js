...
function name(head, tail, reject) {
 ...
 const {capture, match, merge, resolve, process, node} = require("./processor.js"); var grammar = {
    ...
    {"name": "NP", "symbols": ["PN"], "postprocess": (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":1}], l, r)},
    ...
    {"name": "NP", "symbols": ["DET", "__", "RN"], "postprocess": (d, l, r) => process("NP", {"num":1,"gen":2,"case":3,"gap":"-"}, d, [{"num":"sing","rn":"+"},{},{"num":1}], l, r)},
