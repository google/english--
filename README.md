...
`english--` is an experimental [logic](https://en.wikipedia.org/wiki/Logic_programming) language based on a [controlled](https://en.wikipedia.org/wiki/Controlled_natural_language) subset of english.
